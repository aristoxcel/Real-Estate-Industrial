...
function About() {
  return (
    <div>
     ...
     data-aos-duration="500" src="Factories.jpg" className="rounded-lg shadow-2xl mb-4 w-full" />
                ...
                <p className="py-2"><span className="font-bold text-2xl font-franklin text-[#2596BE]" data-aos="fade-right"
     data-aos-easing="linear"
     data-aos-delay="500">Landmark Industrial Group</span> is a leading provider of industrial real estate solutions, dedicated to helping businesses find the perfect space to thrive. With years of experience and a commitment to excellence, we specialize in connecting clients with top-tier industrial properties tailored to their unique needs</p>
