  ...
  <Marker position={[51.505, -0.09]}>
    <Popup>
      ...
      <div className="lg:w-4/5 lg:px-24 px-8 mx-auto lg:py-12 py-8">
            ...
            <h1 className="lg:text-4xl text-2xl font-extrabold py-4 lg:py-6 text-center text-[#2596BE] playfair">Contact with us</h1>
            <p className="text-pera lg:text-base text-sm font-medium text-center lg:w-1/2 md:w-2/3 mx-auto">Contact with us to explore exciting opportunities, share feedback, or inquire about our services.</p>
            ...
            <div className="grid lg:grid-cols-12 grid-cols-1 gap-4 ">
                ...
                <div className="col-span-5">
                    ...
                    <div className="grid grid-rows-3 lg:gap-4 gap-6 border border-[#13131837] rounded-2xl lg:p-8 p-4">
                        ...
                        <FaPhoneVolume className="text-3xl text-[#23BE0A]" />
                            ...
                            <h4 className="text-heading text-lg md:text-base lg:text-lg lg:font-extrabold md:font-semibold font-extrabold">(+880) 01911-309454</h4>
                        </div>
                        ...
                        <MdOutlineAttachEmail className="text-info text-3xl"/>
                            ...
                            <h4 className="text-heading text-lg md:text-base lg:text-lg lg:font-extrabold md:font-semibold font-extrabold">landmark@support.com</h4>
                        </div>
                        ...
                        <IoLocationOutline className="text-3xl text-[#23BE0A]" />
                            ...
                            <h4 className="text-heading text-lg md:text-base lg:text-lg lg:font-extrabold md:font-semibold font-extrabold">Gandaria, Dhaka, Bangladesh</h4>
                        </div>
                ...
                <div className="col-span-7 ">
                    ...
                    <label className="form-control w-full lg:h-[62%] pb-4">
                        ...
                        <textarea className="textarea input-bordered w-full h-full bg-[#13131805]" placeholder="Write your message" rows="4"></textarea>
                    </label>

                    <button className="btn bg-[#2596BE] w-full text-white font-bold text-xl">Send us Message</button>  
                </div>
